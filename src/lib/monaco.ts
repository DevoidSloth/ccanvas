...
function configure() {
  ...
  monaco.editor.defineTheme('ccanvas', {
    ...
    colors: {
      ...
      'editorLineNumber.activeForeground': '#c2c0b6',
      'editorCursor.foreground': '#d97757',
      'editor.selectionBackground': '#f4a93b33',
      'editor.inactiveSelectionBackground': '#f4a93b1f',
      'editor.selectionHighlightBackground': '#6db5a826',
      'editor.lineHighlightBackground': '#15171d66',
      'editor.lineHighlightBorder': '#00000000',
      'editorIndentGuide.background1': '#2f2e2b',
      'editorIndentGuide.activeBackground1': '#4a4843',
      'editorWhitespace.foreground': '#3a3935',
      'editorGutter.background': '#1f1e1d',
      'editorBracketMatch.background': '#6db5a81f',
      'editorBracketMatch.border': '#6db5a866',
      'editorWidget.background': '#262624',
      'editorWidget.border': '#3a3935',
      'editorSuggestWidget.background': '#262624',
      'editorSuggestWidget.border': '#3a3935',
      'editorSuggestWidget.selectedBackground': '#32312e',
      'editorSuggestWidget.highlightForeground': '#d97757',
      'editorHoverWidget.background': '#262624',
      'editorHoverWidget.border': '#3a3935',
      'editorError.foreground': '#d97757',
      'editorWarning.foreground': '#deb566',
      'input.background': '#1f1e1d',
      'input.border': '#3a3935',
      'focusBorder': '#f4a93b66',
      'list.hoverBackground': '#32312e',
      'list.focusBackground': '#32312e',
      'scrollbarSlider.background': '#2c303877',
      'scrollbarSlider.hoverBackground': '#2c3038aa',
      'scrollbarSlider.activeBackground': '#5a5852',
